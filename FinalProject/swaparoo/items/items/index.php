...
<div class="item content-wrapper">
    <div class="overlay">
        <img class = "cover" src="/cs120/FinalProject/swaparoo/../images/items/<?=$item['item_id']?>.webp" alt="<?=$item['title']?>">
    </div>
    <div>
        ...
        <form action="/cs120/FinalProject/swaparoo/cart/addtocart.php" method="post">
