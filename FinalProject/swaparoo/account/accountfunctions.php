...
function profile_info() {
    ...
    if ($stmt = $pdo->prepare('SELECT credits_balance, email FROM Users WHERE user_id = ?')) {
        ...
        echo '<script>alert("Could not find user!"); window.location.href = "/cs120/FinalProject/swaparoo/";</script>';
    }
    ?>
    <div class=balance>
    ...
    <div class="securitysettings">
        ...
        <div class="profilerow">
            ...
            <div class="profilecell editbtn">
                <a href="/cs120/FinalProject/swaparoo/account/changeemail/">
        ...
        <div class="profilerow">
            ...
            <div class="profilecell editbtn">
                <a href="/cs120/FinalProject/swaparoo/account/changepassword/">
                    Edit <i class="fas fa-edit"></i>
                </a>
            </div>
        </div>
...
function transactions_items_rows($transaction_types) {
    ...
    if ($stmt = $pdo->prepare($query)) {
        ...
        while($result = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            <a href="/cs120/FinalProject/swaparoo/items/items/?item=$item_id">    
