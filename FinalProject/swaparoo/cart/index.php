...
<?php require_login('/cs120/FinalProject/swaparoo/cart/') ?>
...
<div class = "cart">
    ...
    WHERE i.item_id = c.item_id AND i.owner_id = u.user_id AND c.user_id = ?;')) {
        ...
        <div class = "emptycart">Your Pouch is empty! Visit the
            <a href="/cs120/FinalProject/swaparoo/items/">Swap Shop<a>
        ...
        echo '<script>alert("Could not find user cart!"); window.location.href = "/cs120/FinalProject/swaparoo/";</script>';
    }
    ?>    
</div>
</div>
