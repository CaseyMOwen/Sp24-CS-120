...
if ($_POST['order_total'] > $_SESSION['credits_balance']) {
    ...
    // header("Location: /cs120/FinalProject/swaparoo/cart/");
    echo '<script>window.location.href = "/cs120/FinalProject/swaparoo/cart/";</script>';
    ...
    // header("Location: /cs120/FinalProject/swaparoo/cart/thankyou/?" .);
    echo '<script>window.location.href = "/cs120/FinalProject/swaparoo/cart/thankyou/?' . $pageref . '";</script>';
}
?>
